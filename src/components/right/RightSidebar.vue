...
import { getDataAssetChange, getDatasetAssetUsageSummary } from '@/api'
...
onMounted(() => {
  void Promise.allSettled([loadUsageSummary(), loadChangeTrend()])
})
</script>
